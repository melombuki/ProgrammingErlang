		...
		switch (_p2.ctor) {
			...
			case 'Send':
				return {
					...
					_1: A2(_elm_lang$websocket$WebSocket$send, 'ws://localhost:8080/websocket', _p3)
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, 'ws://localhost:8080/websocket', _user$project$Main$NewMessage);
};
